...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 86400 blocks, which will occur approximately every 6 months
    nSubsidy >>= (nHeight / 86400); // OmniCoin: 86400 blocks in ~6 months

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 4 * 60 * 60; // OmniCoin: 4 Hours
static const int64 nTargetSpacing = 180; // OmniCoin: 3 Minutes
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "BBC.co.uk - 6/12/2013 - South Africa's Nelson Mandela dies in Johannesburg at Age of 95";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xf1804df13a4b270eae06bef5e0089ea81741a6dcd11e3d3999efce688d8aef29"));
        block.print();
